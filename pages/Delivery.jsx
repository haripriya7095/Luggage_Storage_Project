...
import './Navbar';
// import '../src/css_folder/delivery.css';
import "../src/css_folder/delivery.css"
    ...
    return (
        <div className="largecontainer">
                                ...
                                <form action="" className='flex'>
                                    {currentPage === 1 && (
                                        <div className="page transform transition-transform ease-in-out duration-300 relative">
                                            ...
                                            <div className="field">
                                                <button onClick={nextPage} style={{cursor:"pointer"}} className="firstNext   bg-[#ffa583] mt-2 w-[90%] mx-auto  py-2 text-xl rounded-lg cursor-pointer transition duration-300 hover:scale-105">Next</button>
                                            </div>
                                        </div>
                                    )}
                                    {currentPage === 2 && (
                                        <div className="page transform transition-transform ease-in-out duration-300 relative">
                                            ...
                                            <div className="title pl-[20px]  text-xl">
                                                <h1 ><b>Details</b> of my Courier</h1>
                                            </div>
                                            <div className="field flex flex-col">
                                                <h2 className='text-xl py-2 px-[22px]'>Types of Luggages:</h2>
                                                <div className=' size-list flex items-center justify-between gap-8 mx-4 px-4 mb-[20px] w-[100%]'>
                                                    <div className=''>
                                    ...
                                    {currentPage === 3 && (
                                        <div className="page">
                                            ...
                                            <div className=' flex gap-3 relative'>
                                                <input type='checkbox' className='w-50 h-50' checked={termsChecked}
            ...
            <div className="row2 w-full bg-[#ececec]  mx-auto">
                ...
                <div className='cards max-w-[1240px]  mx-auto grid md:grid-cols-3 gap-8 p-5'>
                    <div className='card mx-auto px-4'>
                        <img src={logo1} alt="" className='sm:w-full w-100 h-80'  />
                    ...
                    <div className='card mx-auto px-4 p-4 ' >
                        <img src={logo2} className='sm:w-full w-100 h-80'  alt="" />
                        <div className='card-body'>
                            <div className='card-heading py-2 sm:text-xl md:text-2xl text-4xl'>
                    ...
                    <div className='card mx-auto px-4'>
                        <img src={logo3} className='sm:w-full w-100 h-80' alt="" />
                        <div className='card-body'>
                            <div className='card-heading py-2 sm:text-xl md:text-2xl text-4xl'>
